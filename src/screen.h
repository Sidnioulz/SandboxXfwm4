...
struct _ScreenInfo
{
    ...
    XfwmColor title_colors[6];
    XfwmColor title_shadow_colors[6];
    xfwmPixmap buttons[BUTTON_COUNT][STATE_COUNT*3];
    xfwmPixmap corners[CORNER_COUNT][6];
    xfwmPixmap sides[SIDE_COUNT][6];
    xfwmPixmap title[TITLE_COUNT][6];
    xfwmPixmap top[TITLE_COUNT][6];
