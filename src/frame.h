...
int                      frameGetColorIndex                     (Client *,
                                                                 int);
int                      frameGetButtonIndex                    (Client *,
                                                                 int);
int                      frameDecorationLeft                    (Client *);
int                      frameDecorationRight                   (Client *);
int                      frameDecorationTop                     (Client *);
int                      frameDecorationBottom                  (Client *);
